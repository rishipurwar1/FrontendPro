...
const ChallengeCard = ({ challenge, challengelist, btnTitle }) => {
    ...
    return (
        <div className="bg-gray-800 shadow-2xl overflow-hidden rounded-md">
            <Image cloudName="di5hmgowi" alt="challenge design" loading="lazy" public-id={challenge.image[0]}>
