    ...
    return (
        <footer className="mt-6 col-start-2 col-end-3 row-start-3 row-end-4 flex xs:flex-col sm:flex-row items-center justify-between py-3 px-4 bg-gray-900 border-t border-gray-800 shadow-lg text-gray-300 h-20">
            ...
            <div className="social flex items-center justify-center">
                <a href="https://github.com/rishipurwar1/coding-space" className="px-2" aria-label="Github" target="_blank" rel="noopener noreferrer"><i className="fab fa-github"></i></a>
                <a href="https://twitter.com/thefierycoder" className="px-2" aria-label="Twitter" target="_blank" rel="noopener noreferrer"><i className="fab fa-twitter"></i></a>
            </div>
        </footer>
    )
}
