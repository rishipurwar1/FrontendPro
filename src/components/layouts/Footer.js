...
const Footer = () => {
    return (
        <footer className="mt-auto sm:ml-0 md:ml-20 xl:ml-56 flex items-center justify-between py-3 px-4  bg-gray-900 border-t border-gray-800 shadow-lg">
            ...
            <div className="social flex items-center">
                ...
                <Link to="#" className="text-gray-300 fa-2x" aria-label="Discord"><i className="fab fa-discord"></i></Link>
            </div>
        </footer>
    )
}
