    ...
    return (
        <div className="container">
            <nav className="flex relative">
                <div className="w-60 border-r border-gray-800 fixed h-full z-10">
                    <Link to="/" className="text-white font-heading uppercase text-center block m-4 mb-8 font-semibold text-2xl"><i className="fas fa-rocket mr-1"></i>CodingSpace</Link>
                    <ul>
