    ...
    <>
      ...
      <main>
        ...
        <section className="rounded-lg bg-gray-900 border border-gray-700 p-6">
          <div className="overflow-hidden relative rounded-lg border border-gray-700">
            <iframe
              className="iframe-embed  w-full -mb-12 overflow-hidden"
              ...
              allowFullScreen
            ></iframe>
            {Object.keys(challenge.figmaURLs).length > 1 && (
            ...
            <div className="text-white">
              <div>
                ...
                <p className="text-gray-300 pt-4">
                  ...
                  you&apos;d like. If you&apos;re trying to learn something new, this
                  might be a great way to push yourself.
                </p>
              </div>
              <div className="mt-10">
              ...
              <div className="mt-10">
                ...
                <ul className="text-gray-300 list-disc pl-5">
                  ...
                  <li>
                    ...
                    particularly adventurous, try writing everything in Vanilla
                    JavaScript.
                  </li>
                </ul>
              </div>
            ...
            <div className="text-white xs:mt-10 md:mt-0">
              ...
              <div className="mt-10">
                ...
                <p className="text-gray-300 pb-2 mt-2">
                  It&apos;s an amazing place to learn and grow as a developer, and
...
export async function getStaticProps({ params }) {
  ...
  const data = await getDocuments("challenges", ["slug", "==", slug])
